...
conn = remote("strange-machine.chal.2024.ctf.acsc.asia", 17777)
...
def solve1():
    ...
    to_send.append(str(x).encode())
    to_send.append(str(y).encode())
...
def solve2():
    ...
    assert target == 0
    to_send.append(sent_bytes.hex().encode())
    ...
    to_send.append(b"3")
    to_send.append(str(bmask).encode())
